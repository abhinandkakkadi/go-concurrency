...
// task is
// we need to create a function expression which takes in pointer to wait groups as arguments and inside that a int will be declared and
// a anonymous concurrent function will be declared. The goroutine uses the int data which is present in it's lexical scope.
